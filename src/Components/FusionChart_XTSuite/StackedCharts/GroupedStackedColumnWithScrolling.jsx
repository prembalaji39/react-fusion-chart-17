...
class GroupedStackedColumnWithScrolling extends React.Component {
  render() {
    return (
      <>
        <h1>Grouped Stacked Column With Scrolling</h1>
        <ReactFusioncharts
...
export default GroupedStackedColumnWithScrolling;
