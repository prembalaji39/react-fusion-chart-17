...
class DualAxisColumnLineAreaWithScrolling extends React.Component {
  render() {
    return (
      <>
        <h1>Dual Axis With Scrolling - Column, Line, Area</h1>
        <ReactFusioncharts
...
export default DualAxisColumnLineAreaWithScrolling;
